...
//        return "404";
    ...
    function print_header($container_start = true, $title = null, $class = "modal-header") {
        if ($title === null) {
            $title = $this->title;
        }
        if ($container_start) {
        ...
        echo "<div class=\"row\"><div style=\"text-align: center;\" class=\"col-lg-12\"><h1 class=\"$class\">$title</h1></div>";
        if ($container_start) {
            echo '</div><div class="row"><div style="text-align: center;" class="col-lg-12">';
        }
    }
         ...
         <div style="text-align: left;" class="row">
             <div style="margin-left: 15px;">
                 <form action="check.php" onsubmit="captureForm(event);" class="form-inline">
                    ...
                    <button type="submit" class="btn btn-default" style="margin-left: 5px;">' . $this->t("action.check") . '</button>
                 </form>
             </div>
             <script type="text/javascript">function captureForm(b){var o=$(".litebans-check-output");var x=setTimeout(function(){o.html("<br>")}, 150);$.ajax({type:"GET",url:"check.php?name="+$("#user").val()+"&table=' . $table . '"}).done(function(c){clearTimeout(x);o.html(c)});b.preventDefault();return false};</script>
         </div>
         <div class="litebans-check litebans-check-output" class="success"></div>
         <br>
         ';
    }
