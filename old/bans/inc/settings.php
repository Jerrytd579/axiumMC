...
final class Settings {
    ...
    public function __construct($connect = true) {
        ...
        $this->host = '104.128.51.126';
        $this->port = 3306;

        $this->database = 's453_litebans';

        $this->username = 'u453_ExCl0sCQLt';
        $this->password = '6LQ5=!aOYvxPgYnU@XBOdHL6';
        ...
        $this->navbar_classes = 'navbar-default navbar-static-top';
        $this->badge_classes = 'badge';
        $this->info_badge_classes = 'label';
        ...
        // 'https://crafatar.com/avatars/{uuid}?size=25&overlay'
        // 'https://minotar.net/avatar/{uuid}/25'
        $this->avatar_source = 'https://minotar.net/helm/{uuid}/30';
        ...
        $this->avatar_source_offline_mode = 'https://minotar.net/helm/{name}/30';
